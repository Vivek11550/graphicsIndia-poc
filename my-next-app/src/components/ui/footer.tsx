      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-10 items-start text-left">
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="flex items-center gap-3">
            <Image src={logo} alt="India Graphic Online Logo" width={45} height={45} />
            <h2 className="text-lg font-semibold">Graphics India Online</h2>
          </div>
          <p className="text-gray-300 hover:text-white text-sm">
            Graphics India Online, a leading Web and Mobile App Development Company based in Camp, Pune
          </p>

          <div className="flex gap-3">
            <Link href="https://www.facebook.com/people/Graphics-India-Online-Pune/100087796726460/" target="_blank" className="p-2 rounded-full bg-white/20 hover:bg-white/40 transition">
              <FaFacebookF size={18} />
            </Link>
            <Link href="https://twitter.com" target="_blank" className="p-2 rounded-full bg-white/20 hover:bg-white/40 transition">
              <FaTwitter size={18} />
            </Link>
            <Link href="https://linkedin.com" target="_blank" className="p-2 rounded-full bg-white/20 hover:bg-white/40 transition">
              <FaLinkedinIn size={18} />
            </Link>
            <Link href="https://www.instagram.com/graphicsindiaonlinepune" target="_blank" className="p-2 rounded-full bg-white/20 hover:bg-white/40 transition">
              <FaInstagram size={18} />
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start gap-2 text-sm mt-1">
          ...
          {[
            ...
            <Link key={service} href="/services" className="text-gray-300 hover:text-white">
              {service}
            </Link>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-4 text-sm text-gray-200 items-start">
          ...
          <div className="flex items-start gap-3">
            <div className="p-2 rounded-full bg-white/20 hover:bg-white/40 transition">
              <FaEnvelope size={18} />
            </div>
            <div>
