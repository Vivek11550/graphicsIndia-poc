...
import digitalGrowthImg from "../../Assets/service-assets/Package-Services.png"; 
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
            All-in-one Digital growth Package for Global Brands
          </h2>
          <p className="text-lg font-semibold text-black mb-4">
              $999/month or $11,499/year
          </p>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm">
            ...
            <li>
              8 Custom Graphics Per Month (Includes Posters, Captions & Hashtags for IG, FB & LinkedIn)
            </li>
        ...
        <div className="w-full md:w-1/2">
          <Image
            src={digitalGrowthImg}
            alt="Digital Growth Suite"
            width={600}
            height={400}
