      ...
      <div className="bg-white shadow-lg rounded-xl p-6 sm:p-8 flex flex-col md:flex-row items-center max-w-6xl w-full gap-8">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed font-poppins">
            ...
            Development, App Development, UI/UX & Web Design, ERP Solutions, and
            SEO Management. We specialize in modern platforms like MERN, MEAN,
            and WordPress, delivering customized digital experiences that cater
            to your unique needs and deliver outstanding results.
          </p>
          <a
            href="/about"
