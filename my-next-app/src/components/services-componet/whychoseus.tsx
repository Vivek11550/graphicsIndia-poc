...
const Whychoseus = () => {
  return (
    <div className="bg-[#132238] text-white  py-10   ">
      ...
      <div className="  sm:flex justify-between mx-[10%]">
  <div className="border border-[#929292] py-5 p-5 m-3 backdrop-blur-md transition-all duration-300 hover:bg-[#929292]/20  rounded-lg">
